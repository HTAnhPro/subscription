# Subscriptions Deployment Guide

This guide walks through deploying Subscriptions from a fresh clone to a working live demo. Two pieces deploy independently:
...
1. Builds the subscriptions contract to `wasm32v1-none/release`.
